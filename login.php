			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						...
						<label class="conl required"><strong><?php echo $lang_common['Username'] ?> <span><?php echo $lang_common['Required'] ?></span></strong><br /><input type="text" name="req_username" size="35" maxlength="50" tabindex="1" /><br /></label>
